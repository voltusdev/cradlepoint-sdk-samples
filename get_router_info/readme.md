...
r = requests.get('http://<router_ip>:8001/status/wan/devices')

# Get routing config
r = requests.get('http://<router_ip>:8001/config/routing/rules')

# Get ECM status
r = requests.get('http://<router_ip>:8001/status/ecm')
```
